...
<?php } else { ?>
    <div class="crl-debug-exception-message">
        <?= $data->getMessage() ?>
    </div>
    <div class="crl-exception-block">
        <div class="crl-exception-line">
            <div>#1</div>
            <div class="crl-exception-file">in <?= $data->getFile() ?></div>
            <div class="crl-exception-row">at line <?= $data->getLine() ?></div>
        </div>
        <?= ExceptionManager::renderFileLines($data->getFile(), $data->getLine(), true) ?>
    </div>

    <?php foreach ($data->getTrace() as $counter => $trace) { ?>
